    ...
    foreach($vision_cards['vision_cards'] as $key => $card) :
      ...
      if($i % 2 != 0) {
        echo '<div class="row vision-card">';
          echo '<div class="col-12 col-md-4 vision-image left" ' . ($card['image'] ? 'style="background-image:url(' . $card['image']['sizes']['medium_large'] . ')"' : '') . '>';
            //no content
          echo '</div>';


          echo '<div class="col-12 col-md-8 vision-content" style="background-color: ' . $card['background_color'] . '; color: ' . midtown_getContrastColor($card['background_color']) . '">';
        ...
        echo '<div class="row vision-card">';
          ...
          echo '<div class="col-12 col-md-4 order-first order-md-last vision-image right" ' . ($card['image'] ? 'style="background-image:url(' . $card['image']['sizes']['medium_large'] . ')"' : '') . '>';
            //no content
          echo '</div>';
